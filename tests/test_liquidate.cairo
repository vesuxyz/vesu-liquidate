...
mod TestLiquidate {
    ...
    use vesu_liquidate::liquidate::{
        ILiquidateDispatcher, ILiquidateDispatcherTrait, RouteNode, TokenAmount, Swap,
        LiquidateParams, LiquidateResponse
    };
    ...
    fn test_liquidate_position_full_liquidation_multi_swap_no_bad_debt() {
        ...
        mock_pragma_oracle.set_price('USDC/USD', SCALE_128 * 9 / 10);
